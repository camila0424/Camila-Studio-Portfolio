...
function Header() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md shadow-sm border-b border-gray-100 h-16">
            <nav className="max-w-7xl mx-auto flex items-center justify-between h-full px-6 md:px-10">

                {/* Logo */}
                <div className="flex items-center cursor-pointer ml-5" onClick={() => smoothScroll("hero")}>
                    <img
                        src={LogoLetras}
