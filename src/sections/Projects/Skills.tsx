                ...
                {openCategory && (
                    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
                        ...
                        >
                            ...
                            <div className="flex-1 flex flex-col overflow-hidden pr-4 border-r border-white/20">
                            ...
                            {selectedTool && (
                                <div className="flex-1 ml-6 p-4 bg-white/10 border border-white/20 rounded-2xl overflow-y-auto h-full">
